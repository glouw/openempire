...
town_center_age1[] = {
    ...
    { {-2, 0}, FILE_GRAPHICS_AGE_1_TOWN_CENTER_ROOF_LEFT },
    { {-2, 0}, FILE_GRAPHICS_AGE_1_TOWN_CENTER_ROOF_LEFT_SUPPORT_A },
    { {-2,-1}, FILE_GRAPHICS_AGE_1_TOWN_CENTER_ROOF_LEFT_SUPPORT_B },
    { { 0, 3}, FILE_GRAPHICS_AGE_1_TOWN_CENTER_ROOF_RITE },
    { { 0, 3}, FILE_GRAPHICS_AGE_1_TOWN_CENTER_ROOF_RITE_SUPPORT_A },
    { { 1, 3}, FILE_GRAPHICS_AGE_1_TOWN_CENTER_ROOF_RITE_SUPPORT_B },
    { { 0, 0}, FILE_GRAPHICS_AGE_1_TOWN_CENTER_SHADOW },
},
town_center_age2[] = {
    { { 0, 0}, FILE_GRAPHICS_AGE_2_WEST_EUROPE_TOWN_CENTER_TOP },
    { {-2, 0}, FILE_GRAPHICS_AGE_2_WEST_EUROPE_TOWN_CENTER_ROOF_LEFT },
    { {-2, 0}, FILE_GRAPHICS_AGE_2_WEST_EUROPE_TOWN_CENTER_ROOF_LEFT_SUPPORT_A },
    { {-2,-1}, FILE_GRAPHICS_AGE_2_WEST_EUROPE_TOWN_CENTER_ROOF_LEFT_SUPPORT_B },
    { { 0, 3}, FILE_GRAPHICS_AGE_2_WEST_EUROPE_TOWN_CENTER_ROOF_RITE },
    { { 0, 3}, FILE_GRAPHICS_AGE_2_WEST_EUROPE_TOWN_CENTER_ROOF_RITE_SUPPORT_A },
    { { 1, 3}, FILE_GRAPHICS_AGE_2_WEST_EUROPE_TOWN_CENTER_ROOF_RITE_SUPPORT_B },
    { { 0, 0}, FILE_GRAPHICS_AGE_2_WEST_EUROPE_TOWN_CENTER_SHADOW },
},
town_center_age3[] = {
    { { 0, 0}, FILE_GRAPHICS_AGE_3_WEST_EUROPE_TOWN_CENTER_TOP },
    { {-2, 0}, FILE_GRAPHICS_AGE_3_WEST_EUROPE_TOWN_CENTER_ROOF_LEFT },
    { {-2, 0}, FILE_GRAPHICS_AGE_3_WEST_EUROPE_TOWN_CENTER_ROOF_LEFT_SUPPORT_A },
    { {-2,-1}, FILE_GRAPHICS_AGE_3_WEST_EUROPE_TOWN_CENTER_ROOF_LEFT_SUPPORT_B },
    { { 0, 3}, FILE_GRAPHICS_AGE_3_WEST_EUROPE_TOWN_CENTER_ROOF_RITE },
    { { 0, 3}, FILE_GRAPHICS_AGE_3_WEST_EUROPE_TOWN_CENTER_ROOF_RITE_SUPPORT_A },
    { { 1, 3}, FILE_GRAPHICS_AGE_3_WEST_EUROPE_TOWN_CENTER_ROOF_RITE_SUPPORT_B },
    { { 0, 0}, FILE_GRAPHICS_AGE_3_WEST_EUROPE_TOWN_CENTER_SHADOW },
},
