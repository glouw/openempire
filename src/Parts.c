...
Parts Parts_GetTownCenter(const Age age)
{
    ...
    static const Part age3[] = {
        ...
        { {-2,2}, FILE_AGE_3_NORTH_EUROPE_TOWN_CENTER_ROOF_LEFT },
        { {-2,2}, FILE_AGE_3_NORTH_EUROPE_TOWN_CENTER_ROOF_LEFT_SUPPORT_A },
        { {-1,1}, FILE_AGE_3_NORTH_EUROPE_TOWN_CENTER_ROOF_LEFT_SUPPORT_B },
        { {-2,2}, FILE_AGE_3_NORTH_EUROPE_TOWN_CENTER_ROOF_RITE },
        { {-2,2}, FILE_AGE_3_NORTH_EUROPE_TOWN_CENTER_ROOF_RITE_SUPPORT_A },
        { {-1,1}, FILE_AGE_3_NORTH_EUROPE_TOWN_CENTER_ROOF_RITE_SUPPORT_B },
    };
