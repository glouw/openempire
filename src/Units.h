...
Units Units_Float(Units floats, const Units units, const Registrar, const Overview, const Grid, const Map, const Motive);
...
Units Units_Generate(Units, const Map, const Grid, const Registrar, const int32_t users, const Color);
