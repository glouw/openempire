...
static void Send(Sockets sockets, const int32_t max_cycle, const int32_t max_ping, const bool game_running)
{
    ...
    const int32_t offset = (fps * (max_ping + CONFIG_SOCKETS_SERVER_UPDATE_SPEED_CYCLES)) / 1000; // XXX. SOMETHING IS NOT RIGHT HERE. NEED TO EXPERIMENT AT DIFFERENT LATENCIES.
