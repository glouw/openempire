...
#define FILE_TEUTONIC_KNIGHT_HEALTH  (18000)
...
#define FILE_X_INTERFAC \
    FILE_X(FILE_INTERFAC_NONE,                       (FILE_NONE),   FILE_PRIO_HIGHEST,  (true ),    TYPE_NONE,              FILE_ZERO,                      FILE_ZERO,                  FILE_ZERO,                   FILE_ZERO,                   FILE_ZERO)

#define FILE_X_TERRAIN \
    FILE_X(FILE_TERRAIN_NONE,                        (FILE_NONE),   FILE_PRIO_HIGHEST,  (true ),    TYPE_NONE,              FILE_ZERO,                      FILE_ZERO,                  FILE_ZERO,                   FILE_ZERO,                   FILE_ZERO) \
    FILE_X(FILE_DIRT,                                     (   0),   FILE_PRIO_TERRAIN,  (true ),    TYPE_NONE,              FILE_ZERO,                      FILE_ZERO,                  FILE_ZERO,                   FILE_ZERO,                   FILE_ZERO) \
    FILE_X(FILE_GRASS,                                    (   1),   FILE_PRIO_TERRAIN,  (true ),    TYPE_NONE,              FILE_ZERO,                      FILE_ZERO,                  FILE_ZERO,                   FILE_ZERO,                   FILE_ZERO) \
    FILE_X(FILE_WATER,                                    (   2),   FILE_PRIO_TERRAIN,  (false),    TYPE_NONE,              FILE_ZERO,                      FILE_ZERO,                  FILE_ZERO,                   FILE_ZERO,                   FILE_ZERO) \
    FILE_X(FILE_FARM,                                     (   3),   FILE_PRIO_TERRAIN,  (true ),    TYPE_NONE,              FILE_ZERO,                      FILE_ZERO,                  FILE_ZERO,                   FILE_ZERO,                   FILE_ZERO)

#define FILE_X_GRAPHICS \
    FILE_X(FILE_GRAPHICS_NONE,                       (FILE_NONE),   FILE_PRIO_HIGHEST,  (true ),    TYPE_NONE,              FILE_ZERO,                      FILE_ZERO,                  FILE_ZERO,                   FILE_ZERO,                   FILE_ZERO) \
    ...
    FILE_X(FILE_STONE_MINE,                               ( 334),   FILE_PRIO_GRAPHICS, (false),    TYPE_STONE_MINE,        FILE_ZERO,                      FILE_ZERO,                  FILE_ZERO,                   FILE_ZERO,                   FILE_ZERO) \
    FILE_X(FILE_TREE_STUMPS,                              ( 335),   FILE_PRIO_GRAPHICS, (true ),    TYPE_NONE,              FILE_ZERO,                      FILE_ZERO,                  FILE_ZERO,                   FILE_ZERO,                   FILE_ZERO) \
    FILE_X(FILE_TREE_CHOPPED_DOWN,                        ( 370),   FILE_PRIO_GRAPHICS, (false),    TYPE_TREE_CHOPPED_DOWN, FILE_ZERO,                      FILE_ZERO,                  FILE_ZERO,                   FILE_ZERO,                   FILE_ZERO) \
    ...
    FILE_X(FILE_FOREST_TREE_SHADOW,                       ( 587),   FILE_PRIO_SHADOW,   (true ),    TYPE_NONE,              FILE_ZERO,                      FILE_ZERO,                  FILE_ZERO,                   FILE_ZERO,                   FILE_ZERO) \
    FILE_X(FILE_BERRY_BUSH,                               ( 698),   FILE_PRIO_GRAPHICS, (false),    TYPE_BERRY_BUSH,        FILE_ZERO,                      FILE_ZERO,                  FILE_ZERO,                   FILE_ZERO,                   FILE_ZERO) \
    FILE_X(FILE_WAYPOINT_FLAG,                            ( 795),   FILE_PRIO_GRAPHICS, (true ),    TYPE_NONE,              FILE_ZERO,                      FILE_ZERO,                  FILE_ZERO,                   FILE_ZERO,                   FILE_ZERO) \
    FILE_X(FILE_RIGHT_CLICK_RED_ARROWS,                   ( 796),   FILE_PRIO_GRAPHICS, (true ),    TYPE_NONE,              FILE_ZERO,                      FILE_ZERO,                  FILE_ZERO,                   FILE_ZERO,                   FILE_ZERO) \
    FILE_X(FILE_GOLD_MINE,                                (1297),   FILE_PRIO_GRAPHICS, (false),    TYPE_GOLD_MINE,         FILE_ZERO,                      FILE_ZERO,                  FILE_ZERO,                   FILE_ZERO,                   FILE_ZERO) \
    FILE_X(FILE_FOREST_TREE,                              (1410),   FILE_PRIO_GRAPHICS, (false),    TYPE_TREE,              FILE_ZERO,                      FILE_ZERO,                  FILE_ZERO,                   FILE_ZERO,                   FILE_ZERO)
