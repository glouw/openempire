...
{
    // Image and frame contain both tile size info and outline padding info
    // for terrain tiles. This will aid the bytemask unpacking, as outline padding is not inserted.
    //
    // Arbitrarly, the DIRT file is used.
