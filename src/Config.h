...
#define CONFIG_SOCKETS_SERVER_TIMEOUT_MS (1)

#define CONFIG_MAIN_LOOP_SPEED_MS (15)

#define CONFIG_SOCKETS_THRESHOLD_START (20)
...
#define CONFIG_UNITS_STARTING_AREA_TILE_SPACE (20)

#if SANITIZE_ADDRESS == 1 || SANITIZE_THREAD  == 1 || SANITIZE_UNDEFINED == 1
    #define CONFIG_SOCKETS_SERVER_UPDATE_SPEED_CYCLES (500)
#else
    #define CONFIG_SOCKETS_SERVER_UPDATE_SPEED_CYCLES (50)
#endif
