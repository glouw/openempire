...
#define CONFIG_ANIMATION_DECAY_DIVISOR (10 * CONFIG_ANIMATION_DIVISOR)
...
#define CONFIG_SOCKETS_THRESHOLD_START (1 /* SECONDS */ * (1000 / CONFIG_MAIN_LOOP_SPEED_MS))
...
#define CONFIG_PLAYER_CYCLE_WINDOW (300) // PLAYERS MUST BE WITHIN THIS CYCLE WINDOW ELSE GAME GOES OUT OF SYNC.
...
#define __CONFIG_SOCKETS_SERVER_UPDATE (10)
...
#define CONFIG_VRAM_FLASH_TIMER_RATE (5)
